...
def loadCompleteSessionContext():
    ...
    for csvfile in csvfiles:
        df = pd.read_csv(csvfile, dtype={'session_id': str, 'session_position': int, 'session_length': int, 'track_id_clean': str, 'skip_1': bool, 'skip_2': bool, 'skip_3': bool, 'not_skipped': bool, 'context_switch': int, 'no_pause_before_play': int, 'short_pause_before_play': int,
